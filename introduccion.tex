...
\begin{figure}[H]
  ...
  public void testDequeueExc() {
	...
	\end{lstlisting}
	\caption{Tests para el m\'etodo dequeue \ref{figures.motivation.queue-class}}
...
\begin{figure}[H]
  ...
  ...
	\end{lstlisting}
	\caption{Un mutante en donde se cambi\'o \lstinline{this.front.next} a \lstinline{this.last.next} en la sentencia que avanza el puntero \emph{front} al desencolar un elemento.}
...
\begin{figure}[H]
  ...
  public void dequeueTest() {
	...
	\end{lstlisting}
	\caption{Test que detecta el mutante que afecta la sentencia de avance del puntero \emph{front} en el m\'etodo \emph{dequeue()} \ref{figures.motivation.dequeue-prvo-mutant}}
...
\paragraph{Definir un operador de mutaci\'on para expresiones de navegaci\'on}
...
\paragraph{Aplicaciones del operador de mutaci\'on en reparaci\'on}
