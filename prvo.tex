...
\begin{figure}
	\begin{displaymath}
	\begin{array}{lll}
	PRVO([e] : O \rightarrow T, \rho) & = & \{[f] : O \rightarrow T| [f] \in (\rho)^\ast\} 
	\end{array}
	\end{displaymath}
